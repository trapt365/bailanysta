        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center space-x-6 text-gray-500">
            ...
            <button 
              ...
              className={`flex items-center space-x-2 transition-colors rounded-full p-1 hover:bg-blue-50 dark:hover:bg-blue-900/20 ${
                showComments 
            ...
            <button className="flex items-center space-x-2 hover:text-green-600 transition-colors rounded-full p-1 hover:bg-green-50 dark:hover:bg-green-900/20">
